const About = () => {
  return (
    <div className="bg-white/40 w-full h-fit mt-8 flex justify-between p-8">
        <div className="w-1/2 p-4 text-gray-700">
            <h2 className="text-2xl font-bold mb-4">About FireStats</h2>
            <p>
                FireStats is your ultimate platform for detailed and comprehensive statistics on NBA players.
                ...
                Whether you're a casual fan or a stats enthusiast, FireStats provides a seamless way to 
